<template>
	<view class="Container1">
		<view class="card1">
			<view class="changchunGroup">
				<view class="changchun" :class="ccShow?'changchunactive':''" @tap="chooseSQ(1)">
					长春赛区
				</view>
				<view class="changchun" :class="!ccShow?'changchunactive':''" @tap="chooseSQ(2)">
					辽源赛区
				</view>
			</view>
			<view class="" v-show="ccShow==true" >
			...
			<view class="card_content">
				...
				<view class="form1">
					...
					<input type="text" value="" v-model="city" placeholder="请输入选手所在城市" />
				</view>
				<view class="form1">
					<text>
						<text style="color: red;">*</text>
					...
					<input type="text" value="" v-model="xianqu" placeholder="请输入选手所在区县" />
				</view>
<!-- 				<view class="form1">
					<text>
						<text style="color: red;">*</text>
					...
					<input type="text" value="" v-model="quyu" placeholder="请输入选手所在区域" />
				</view> -->
		...
		<view class="" v-show="ccShow==false">
			<view class="card_title">填写信息</view>
			<view class="card_content">
				<view class="form1">
					<text>
				...
				<button class="f_btn" @tap="commit1">提 交</button>
	...
	methods: {
		...
		commit(e) {
			...
			if (!myreg.test(that.phone)) {
				...
				let url = 'api/home/index/submitPost';
				let data = {
					name: that.name,
					mobile: that.phone,
					age: that.year,
